% ethercat(SECTION) | User Commands
%
% "August 18 2023"
...
ethercat - program to do something

# SYNOPSIS

**ethercat** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**ethercat** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **ethercat** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**ethercat** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    ethercat. See **foo.conf**(5) for further details.
...
**ethercat** provides some return codes, that can be used in scripts:
...
Rin Iwai <rin@eyrin.jp>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Rin Iwai
